...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/rukshanchamindu/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.1-Casita/Install/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh
 > /dev/null 2>&1
