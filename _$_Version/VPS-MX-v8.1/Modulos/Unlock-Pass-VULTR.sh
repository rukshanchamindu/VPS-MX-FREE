...
wget https://raw.githubusercontent.com/rukshanchamindu/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.1-Casita/Install/ArchivosUtilitarios/common-password -O /etc/pam.d/common-password > /dev/null 2>&1
