...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/rukshanchamindu/VPS-MX-FREE/main/VPS-MX-v8.3.1/Install/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	#chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/rukshanchamindu/VPS-MX-FREE/main/VPS-MX-v8.3.1/Install/zzupdate.sh -O /usr/local/vpsmxup/vpsmxup.sh &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.sh
	rm -rf /usr/bin/vpsmxup
    wget https://raw.githubusercontent.com/rukshanchamindu/VPS-MX-FREE/main/VPS-MX-v8.3.1/Install/zzupdate.sh -O /usr/bin/vpsmxup &> /dev/null
...
ubu16_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/rukshanchamindu/VPS-MX-FREE/main/VPS-MX-v8.3.1/Install/Repositorios/16.04/sources.list &> /dev/null
	echo -e "\033[1;97m SELECCIONO UBU 16"
}

ubu18_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/rukshanchamindu/VPS-MX-FREE/main/VPS-MX-v8.3.1/Install/Repositorios/18.04/sources.list &> /dev/null
