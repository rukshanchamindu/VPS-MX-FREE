...
if [ "$pid_badvpn" = "" ]; then
    ...
    wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/rukshanchamindu/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX_Oficial/ArchivosUtilitarios/badvpn-udpgw &>/dev/null
