...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/rukshanchamindu/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
