...
source <(curl -sL https://raw.githubusercontent.com/rukshanchamindu/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/V2RAY/install-v2ray.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/rukshanchamindu/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/V2RAY/install-v2ray.sh) --remove > /dev/null 2>&1
